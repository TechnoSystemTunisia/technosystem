      ...
      <div className='flex flex-col items-center justify-center gap-10 my-4 max-w-[1460px]'>
        <div className='flex flex-col items-center justify-center lg:w-[70%] w-full p-4 gap-4'>
          <div className='flex flex-col items-center w-full text-center'>
            <h1 className='font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 capitalize'>nos expertises</h1>
            <h1 className='font-extrabold text-transparent text-4xl lg:text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 capitalize'>a votre service</h1>
          </div>
